...
La historia que cuenta es periodismo de datos honesto sobre una corrida. Un
...
hallazgo se reporta honestamente como el resultado de una corrida, no como una tasa.
...
agentes en periodismo de datos honesto:
...
- **Compilaciones deterministas byte a byte.** La misma entrada produce los mismos
  ...
  byte a byte.
- **Encuadre honesto de muestra pequena / n=1.** La corrida es una sola muestra. El
...
- Que un hallazgo "sorprendente" puede reportarse **honestamente**: el resultado
...
es donde se imponen las garantias de honestidad. Aserciones clave:
...
- Proyecto: `ai-experiments-487722`
- Region: `us-central1`
...
dentro de este generador seria deshonesto: invitaria a numeros inventados o
...
determinista byte a byte -- es lo que hace que las garantias de honestidad sean
...
convertir telemetria de agentes en periodismo de datos honesto.
